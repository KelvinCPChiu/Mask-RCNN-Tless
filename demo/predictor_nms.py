...
from maskrcnn_benchmark.structures.boxlist_ops import boxlist_nms as NMS
...
class COCODemo(object):
    ...
    def run_on_opencv_image(self, image, nms_thresh=0.5):
        """
        Arguments:
...
#   print(predictions.bbox.shape)
        predictions = NMS(predictions, nms_thresh=nms_thresh)
